plot4 <- function(){
  ...
  par(mfrow = c(2,2))
  with(subsetdata, plot(full_time, Global_active_power, type = "l", xlab = "", ylab = "Global Active power"))
  with(subsetdata, plot(full_time, Voltage, type = "l", xlab = "date time", ylab = "Voltage"))
  with(subsetdata, plot(full_time,Sub_metering_1, type = "l", xlab = "", ylab = "Energy sub metering"))
  ...
  with(subsetdata, plot(full_time,Global_reactive_power,type = "l", xlab = "date time", ylab = "Global_reactive_power"))
  dev.off()
}